...
public interface CompanyMapper {
    ...
    // 참여기업 목록
    List<Company> getList(Integer startNum, Integer pageSize, String search, String type, String status, Integer round, String roundValue);

    // 참여 기업 목록 개수
    Integer countAll(String type, String search, String status, Integer round, String roundValue);
