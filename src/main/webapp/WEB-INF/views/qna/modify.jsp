        ...
        <div class="col-12 col-md-8 col-lg-6">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="contentTextarea" rows="10"
                              name="content">${question.content }</textarea>
                </div>
                <div class="mb-3">
                    <label class="form-label">작성일시</label>
                    <input class="form-control" style="background-color: white" type="text" value="${question.created }" readonly/>
                </div>

                <div class="mb-3">
                    <input class="btn btn-secondary" type="submit" value="수정"/>
                    <a href="/qna/QnaList" class="btn btn-secondary">목록으로가기</a>
                </div>
            </form>
        </div>
    </div>
