...
<div class="container-lg">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            ...
            <div class="mb-3">
                <label for="input-ceo-name" class="form-label">대표명</label>
                <input id="input-ceo-name" type="number" class="form-control" name="ceo-name"/>
            </div>
...
<script src="/js/recruiter/reg.js"></script>
</body>
</html>